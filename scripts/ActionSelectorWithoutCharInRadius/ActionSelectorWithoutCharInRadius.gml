...
function Action_Selector_Without_Char_In_Radius(arg_radius = 1, arg_elements_to_select = 1) 
{
	var all_empty_tile_in_distance = function(closed_arg_radius) {
		closedFunction = {
			__distance: closed_arg_radius,
	...
	var selectorActionWithoutCharacter = MySelectorActionClass(all_empty_tile_in_distance(arg_radius));
